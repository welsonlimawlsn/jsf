...
public class NewRegistrationFlowBuider implements Serializable {
    @Produces
    @FlowDefinition
    public Flow defineFlow(@FlowBuilderParameter FlowBuilder flowBuilder){
        ...
        flowBuilder.viewNode(flowId, "/newregistration/newregistration.xhtml3");
        ...
        flowBuilder.flowCallNode("callNewPendecies").flowReference("", "newpendencies")
